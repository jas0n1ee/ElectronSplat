...
test('USB Win/Linux folders and root-level Mac app share one scene data root',()=>{
  for(const [platform,execPath,expected,dataRoot] of [
    ['win32','E:\\U 盘\\Win\\Portable.exe','E:\\U 盘','E:\\U 盘\\Win'],
    ['linux','/media/U 盘/Linux/Portable','/media/U 盘','/media/U 盘/Linux'],
    ['darwin','/Volumes/U 盘/Portable.app/Contents/MacOS/Portable','/Volumes/U 盘','/Volumes/U 盘']
  ]){
...
test('explicit data-dir and development runs remain isolated from parent scene directories',()=>{
  const result=desktopPaths({platform:'linux',execPath:'/usb/Linux/Portable',isPackaged:true,override:'/tmp/test isolated'});
